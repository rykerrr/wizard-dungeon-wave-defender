...
namespace WizardGame.Combat_System
{
    ...
    {
        [SerializeField] protected GameObject spellPrefab = default;
        ...
        public override void FinishSpellCast()
        {
            ...
            spellClone.GetComponent<SpellEnergyBall>().InitSpell(1f, 1f,
                intStat.ActualValue, 1 + 1/intStat.ActualValue,
                Owner);
